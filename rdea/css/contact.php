...
<html lang="en">
<head>
  <title>Contact - Summentor Pro</title>
</head>
<body>
<div id="page">
...
.single-contact-address-box.main-branch {
    /*background: #FFA500;*/
    background-image: linear-gradient(to right, #D59C16,#E5C44B,#FDF386,#FFDF61);
...
<section class="contact-address-area" style="margin-top: 8%;margin-bottom: 5%;">
    <div class="container">
                ...
                <div class="contact-address-box row">
                    ...
                    <div class="col-sm-4 single-contact-address-box text-center">
                      ...
                      <div class="row" style="width:auto;">
                        <h2 style="color:white">Will Contact You Soon</h2>
                         <div class="col-md-4">
                            <a href="https://www.instagram.com/summenevents17/" target='_blank'>
                                <img src="img/footer/twitter.png" height="30px" width="30px">
                            </a>
                         </div>
                         <div class="col-md-4">
                            <a href="https://www.instagram.com/summenevents17/" target='_blank'>
                        ...
                        <div class="inner">
                            <ul>
                                <li>
                                    ...
                                    <div class="text">
                                        <p>5th Block, SPD plaza, #52, 1st, Jyoti Nivas College Road, Koramangala Insdustrial Layout, Bengaluru, Karnataka 560034</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="title">
                                    ...
                                    <div class="text">
                                        <p><a href="tel:08043729419">080-43729419</a><br><br></p>
                                    </div>
                                </li>
                                <li>
                                    <div class="title">
                                    ...
                                    <div class="text"><p><a href="mailto:info@summentorpro.com">info@summentorpro.com</a>
                                    <br><br></p>
                                    </div>
                                </li>
                            </ul>
        ...
        <div class="row">
            <div class="col-md-12" style="margin-bottom: 5%;">
                ...
                <div class="contact-form">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="sec-title-style1 float-left">
                                <div class="title"><h1>Send Your Message</h1></div>
                    ...
                    <div class="inner-box">
                        <form id="contact-form" name="contact_form" class="default-form" method="post" action="mail/mail_handler5.php">
                            <div class="row">
                                <div class="col-xl-6 col-lg-12">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="input-box">    
                                                <textarea name="form_message" name="message" id="message"placeholder="Your Message..." required=""></textarea>
                                            </div>
                                        </div>  
                                    </div>  
                                </div>
                                <div class="col-xl-6 col-lg-12">    
                                    <div class="button-box">
                                        ...
                                        <button type="submit" data-loading-text="Please wait..."  name="submit">Send Message<span class="flaticon-next"></span></button>    
                                    </div>         
                                </div> 
                            </div>
                        </form>
